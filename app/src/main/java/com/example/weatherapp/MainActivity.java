...
public class MainActivity extends AppCompatActivity {
    ...
    public void weatherInfo() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, jsonURL,
                this::onResponse, error -> Toast.makeText(MainActivity.this.getApplicationContext(), error.getMessage(), Toast.LENGTH_SHORT).show());
    ...
    private void onResponse(String response) {
        ...
        try {
            ...
            windSpeed.setText(String.format("%s m/s", WindSpeed));
            ...
            temperature.setText(String.format("%s°C", Temperature));
